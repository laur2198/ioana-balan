...
| B9 | Oferta pleacă în aceeași zi **cu prețul final**, transportul și cazarea deja calculate: „pentru un preț ferm, nu pentru o estimare” (Giurgiu), pachet, drum și cazare pe rânduri separate (Dolj). | `zona-giurgiu`, `zona-dolj`, `zona-constanta`, `zona-brasov`, `zona-ilfov` | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17). Pe grand-music.ro rezervarea trece printr-o întâlnire („stabilim de comun acord o întâlnire pentru a discuta termenii și condițiile”); „în aceeași zi primiți … oferta” de pe ioana-balan.ro e textul prototipului. | ☑ da ☐ nu ☐ parțial | Pe `oferte.html` apare doar răspunsul în aceeași zi, nu și prețul ferm cu transport inclus. **2026-09-17.** Răspuns: „oferta pleacă cu prețurile finale, iar clienții trebuie să își aleagă un pachet”. „În aceeași zi” nu a fost comentat explicit. |
