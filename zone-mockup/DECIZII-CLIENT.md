# Decizii care așteaptă răspunsul clientului

**Răspunsurile care deblochează publicarea sunt extrase în `DECIZII-CLIENT-URGENT.md`.**
Documentul de aici e referința completă, la care se răspunde când e timp.

**Prima rundă de răspunsuri, 2026-09-17.** Confirmate: A1, A2, A3–A12, A14, A17–A21 (cazarea: cost separat, detaliile per eveniment), B4, B9, B10, B21, B37, B42, B46, B48, B49, B55, B57, B60, B61, B64, B65, B66, B68, B69, B74, D4, D8, D10. Opt afirmații din B (B4, B37, B42, B48, B49, B61, B64, B65, B66) au primit răspunsuri de tipul „se discută la telefon” sau „în funcție de sală”: mirii le stabilesc cu Liviu, per eveniment. Pe pagini au rămas, reformulate ca subiecte ale discuției de organizare, nu ca angajamente. **Rămân deschise**, în a doua rundă, direct către Liviu: A24, A25, A26, A27, B26, B43, B75, D9.

**A doua rundă, direct de la Liviu.** Închise: A24 și A26 (montaj 4–5 ore), A25 și A27 (puterea electrică, scoasă de pe site), A92 (prețurile de botez, ferme), B26 și B43 (scoase de pe site), B75 (confirmat), D4 („interpret manele”), D9 (confirmat verbal), marcajul de cazare de pe Brașov (A19) și rândul orfan din prima rundă. Rămâne de obținut doar confirmarea **scrisă** pentru D9. Observațiile de semnalat, fără întrebare, sunt în secțiunea E.

Tot ce e scris pe cele 20 de pagini noi și nu poate rămâne așa fără confirmare, adunat
într-un singur loc. Textele sunt **extrase din pagini**, nu reconstituite din memorie:
...
|---|---|---|
| **A** | client | valori operaționale lipsă: tarife, cazare, montaj, formule, material |
| **B** | client | afirmații despre cum lucrează echipa, scrise fără date de la client |
| **C** | artistă | afirmații de folclor și repertoriu, pe zone etnografice (anexă, neblocant) |
| **D** | client + noi | decizii pe paginile existente și pe scope |
| **E** | client | observații de semnalat: nepotriviri între site-uri, fără întrebare |

**Nivel.** **Blocant** = fără răspuns, pagina nu se publică: marcajul rămâne vizibil sau
angajamentul nu poate rămâne neconfirmat. **Neblocant** = pagina se publică fără răspuns,
iar coloana „Dacă nu vine răspunsul” spune ce se face cu textul. În B, blocante sunt doar
...
notă). Un „nu” sau un „parțial” pe o afirmație care apare pe mai multe pagini se
corectează peste tot unde apare.

---

## A. Valori operaționale

Fiecare valoare apare **o singură dată**, chiar dacă marcajul e pe mai multe pagini (de
exemplu `[TARIF RON/KM — de confirmat]` e pe 13). Coloana „Pagini” arată unde se
completează. Marcajele formulate diferit rămân pe rânduri separate, chiar dacă întreabă
același lucru (A2: cine suportă cazarea, în cinci formulări), ca să se vadă exact ce text
se înlocuiește. Răspunsul se poate da o dată, pentru tot grupul.

<!-- generat din pagini: 91 valori distincte, 151 apariții -->
<!-- A92 adăugat manual în runda 2 (prețurile de botez, din .price-tbc pe ../oferte.html) -->

### A1. Prețuri și tarife

| # | Marcaj, text exact | Pagini | Nivel | Sursa pe live | Dacă nu vine răspunsul | Răspuns |
|---|---|---|---|---|---|---|
| A1 | [INTERVAL PREȚ ARGEȘ — de confirmat] | `zona-arges` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A2 | [TARIF RON/KM — de confirmat] | `zona-arges`, `zona-brasov`, `zona-buzau`, `zona-calarasi`, `zona-constanta`, `zona-dambovita`, `zona-dolj`, `zona-giurgiu`, `zona-ialomita`, `zona-ilfov`, `zona-prahova`, `zona-teleorman`, `zone` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „se percepe un tarif de 6 RON/Km dus-întors” · `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „6RON/km dus-întors” · `ioana-balan.ro/termeni-si-conditii/` (valoare completată pe live în șablonul nostru, autor neverificat): „6 lei/km, calculat dus-întors”. | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **6 lei/km, dus-întors**, în afara Bucureștiului și a Ilfovului. Completat pe cele 12 zone, pe `zone` și pe `../oferte.html` (2026-09-17). **18.09.2026:** rândul rămâne închis și e acum verificat automat — `verify/integritate.py`, `check_transport()` cere aceeași valoare și aceeași bază de calcul pe toate cele 12 pagini și blochează reapariția unui placeholder de tarif kilometric. Formulările diferă de la pagină la pagină, intenționat: unsprezece scriu „6 lei/km”, `zona-ialomita` scrie „cu 6 lei fiecare [kilometru]”. Vezi și A94. |
| A3 | [INTERVAL PREȚ BRAȘOV — de confirmat] | `zona-brasov` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A4 | [INTERVAL PREȚ BUZĂU — de confirmat] | `zona-buzau` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A5 | [INTERVAL PREȚ CĂLĂRAȘI — de confirmat] | `zona-calarasi` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A6 | [INTERVAL PREȚ CONSTANȚA — de confirmat] | `zona-constanta` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A7 | [INTERVAL PREȚ DÂMBOVIȚA — de confirmat] | `zona-dambovita` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A8 | [INTERVAL PREȚ DOLJ — de confirmat] | `zona-dolj` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A9 | [INTERVAL PREȚ GIURGIU — de confirmat] | `zona-giurgiu` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A10 | [INTERVAL PREȚ IALOMIȚA — de confirmat] | `zona-ialomita` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
| A11 | [INTERVAL PREȚ ILFOV — de confirmat] | `zona-ilfov` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică), **fără supliment de transport**: București și Ilfov sunt grila de bază. Completat pe pagină (2026-09-17). |
| A12 | [INTERVAL PREȚ PRAHOVA — de confirmat] | `zona-prahova` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
...
| A14 | [INTERVAL PREȚ TELEORMAN — de confirmat] | `zona-teleorman` | confirmat (2026-09-17) | `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „Configurația pachetelor și preturile sunt valabile doar pentru București și Ilfov pentru anul 2026-2027” · nuntă Standard „5500” sâmbătă / „4800EURO” duminică, Premium „6500” / „5500EURO”. Intervalul pe județ nu e publicat ca cifră: rezultă din grilă plus tariful A2. Doar pe grand-music.ro (grila de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4.800 €** („de la”, Standard duminică) + transport 6 lei/km dus-întors, pe distanța până la localitate. Fără interval combinat euro + lei. Completat pe pagină (2026-09-17). |
...
| A92 | Prețuri botez pe `../oferte.html`, marcate `.price-tbc`: Standard 3.200 € sâmbătă / 2.800 € duminică, Premium 3.800 € / 3.300 € | `../oferte.html` | confirmat (runda 2) | negăsit pe niciun domeniu: grila de pe `grand-music.ro/oferta-formatii-nunta/` are doar nunta; pe `ioana-balan.ro/oferte/` e textul prototipului (vezi `SURSE-LIVE.md`, §2) | Marcajele `.price-tbc` rămân vizibile, iar JSON-LD-ul nu declară preț pentru botez. | Clientul: prețurile de pe site-ul live rămân, ca ferme (runda 2). `.price-tbc` scos de pe cele 4 cifre; `offers` cu preț adăugate în JSON-LD, pe București și Ilfov. |

### A2. Cazarea echipei

| # | Marcaj, text exact | Pagini | Nivel | Sursa pe live | Dacă nu vine răspunsul | Răspuns |
|---|---|---|---|---|---|---|
| A17 | [CINE SUPORTĂ CAZAREA, CÂND E NECESARĂ — de confirmat] | `zona-arges`, `zona-buzau`, `zona-calarasi`, `zona-ialomita`, `zona-teleorman` | confirmat (2026-09-17) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „percepem un cost suplimentar de transport (in suma de 6RON/km dus-întors) și cazare”. Doar pe grand-music.ro (fraza despre cazare de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | Runda 1: cost separat de pachet. **Runda 2, clientul:** se asigură de miri, detaliile se discută la telefon cu Liviu, după cum vor mirii. Pe pagini textul spune doar că modul concret se stabilește la discuția de organizare, după distanță, tipul evenimentului și preferința mirilor; formulările din runda 1 care afirmau facturarea separată au fost aliniate. Vezi E2. |
| A18 | [CINE SUPORTĂ CAZAREA — de confirmat: inclus în preț sau facturat separat] | `zona-brasov` | confirmat (2026-09-17) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „percepem un cost suplimentar de transport (in suma de 6RON/km dus-întors) și cazare”. Doar pe grand-music.ro (fraza despre cazare de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | Runda 1: cost separat de pachet. **Runda 2, clientul:** se asigură de miri, detaliile se discută la telefon cu Liviu, după cum vor mirii. Pe pagini textul spune doar că modul concret se stabilește la discuția de organizare, după distanță, tipul evenimentului și preferința mirilor; formulările din runda 1 care afirmau facturarea separată au fost aliniate. Vezi E2. |
| A19 | [CAZARE — de confirmat: inclusă în preț, facturată separat, sau asigurată de miri] | `zona-brasov` | confirmat (runda 2) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „percepem un cost suplimentar de transport (in suma de 6RON/km dus-întors) și cazare”. Doar pe grand-music.ro (fraza despre cazare de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **Completat în runda 2** pe `zona-brasov`: cine asigură cazarea și în ce formă se stabilește la discuția de organizare. Nu se afirmă că o asigură mirii (vezi E2). |
| A20 | [CAZARE — de confirmat] | `zona-calarasi`, `zona-constanta`, `zona-teleorman` | confirmat (2026-09-17) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „percepem un cost suplimentar de transport (in suma de 6RON/km dus-întors) și cazare”. Doar pe grand-music.ro (fraza despre cazare de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | Runda 1: cost separat de pachet. **Runda 2, clientul:** se asigură de miri, detaliile se discută la telefon cu Liviu, după cum vor mirii. Pe pagini textul spune doar că modul concret se stabilește la discuția de organizare, după distanță, tipul evenimentului și preferința mirilor; formulările din runda 1 care afirmau facturarea separată au fost aliniate. Vezi E2. |
| A21 | [CINE SUPORTĂ CAZAREA — de confirmat] | `zona-constanta`, `zona-dolj` | confirmat (2026-09-17) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „percepem un cost suplimentar de transport (in suma de 6RON/km dus-întors) și cazare”. Doar pe grand-music.ro (fraza despre cazare de pe ioana-balan.ro e textul prototipului). | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | Runda 1: cost separat de pachet. **Runda 2, clientul:** se asigură de miri, detaliile se discută la telefon cu Liviu, după cum vor mirii. Pe pagini textul spune doar că modul concret se stabilește la discuția de organizare, după distanță, tipul evenimentului și preferința mirilor; formulările din runda 1 care afirmau facturarea separată au fost aliniate. Vezi E2. |
...
| A24 | [MARJĂ MONTAJ — de confirmat: nr. ore înainte de primul moment muzical] | `zona-brasov` | confirmat (runda 2) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „Staff-ul tehnic ajunge la locație cu aproximativ 4-5 ore inainte de începereea evenimentului.” Doar pe grand-music.ro. | Se completează cu valoarea publicată, după verificarea colectivă din `DECIZII-CLIENT-URGENT.md`. Dacă valoarea nu mai e valabilă, rândul redevine blocant. | **4–5 ore** înainte de începerea evenimentului (confirmat, runda 2). Completat pe `zona-brasov`, ca aceeași informație cu durata montajului (A26), nu ca un al doilea termen. |
| A25 | [PUTERE ELECTRICĂ NECESARĂ — de confirmat] | `zona-brasov` | închis (runda 2) | negăsit pe niciun domeniu (verificat 2026-09-17) | fără răspuns, pagina nu se publică | Clientul: „nu mi se pare relevant”. **Scos de pe site** (runda 2): marcajul și fraza care îl purta. Pe `zona-brasov` fraza a rămas doar cu accesul pentru montaj. |
| A26 | [DURATĂ MONTAJ — de confirmat] | `zona-brasov`, `zona-buzau`, `zona-dolj`, `zona-giurgiu`, `zona-ialomita`, `zona-ilfov`, `formatia` | confirmat (runda 2) | negăsit pe niciun domeniu (verificat 2026-09-17). Parțial: `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13) dă ora de sosire (4-5 ore înainte) și proba de sunet („între 30-60 de minute”), nu durata montajului. | fără răspuns, pagina nu se publică | **4–5 ore** (confirmat, runda 2). Completat pe `formatia`, `zona-brasov`, `zona-buzau`, `zona-dolj`, `zona-giurgiu`, `zona-ialomita`, `zona-ilfov`, cu formulare diferită pe fiecare. |
| A27 | [PUTERE ELECTRICĂ — de confirmat] | `zona-calarasi`, `zona-constanta`, `zona-dambovita`, `zona-giurgiu`, `zona-prahova`, `zona-teleorman`, `formatia`, `eveniment-privat` | închis (runda 2) | negăsit pe niciun domeniu (verificat 2026-09-17) | fără răspuns, pagina nu se publică | Clientul: „cine e interesat îl întreabă direct pe Liviu la telefon”. **Scos de pe site** (runda 2), fără o formulare de înlocuire despre curent: `formatia` și `zona-calarasi` — paragraf scos; `eveniment-privat`, `zona-dambovita`, `zona-prahova` — fraza rescrisă fără curent; `zona-constanta`, `zona-giurgiu`, `zona-teleorman` — răspunsul FAQ reconstruit pe celelalte verificări. |
...
| # | Marcaj, text exact | Pagini | Nivel | Sursa pe live | Dacă nu vine răspunsul | Răspuns |
|---|---|---|---|---|---|---|
| A42 | [FACTURARE PE FIRMĂ — de confirmat] | `corporate` | neblocant | | Se scoate marcajul; „Contractul și factura se emit pe firmă.” rămâne doar dacă D8 e „da”. | **Pe firmă, direct**, nu prin agenție (D8). Completat pe pagină (2026-09-17, runda 2). |
...
| A45 | [CONTRACTARE PRIN AGENȚIE — de confirmat] | `corporate` | neblocant | | Se scoate fraza „Cine semnează contractul…”; răspunsul rămâne cu prima frază. | **Contractul și factura direct cu firma**, nu cu agenția; agenția poate rămâne persoană de contact (D8). Completat pe pagină (2026-09-17, runda 2). |
...
> **REZOLVAT PARȚIAL — 18.09.2026.** Clienta a trimis o listă de săli unde a
> cântat formația. Rândurile de mai jos **nu se închid**: lista dă doar *nume și
> localitate*, iar cardurile de aici cer fotografie (A57), tip de eveniment
> (A58) și recenzie (D5). Ce s-a deblocat e altceva — un modul nou, de listă,
> descris în `NAV-FOOTER-MIGRARE.md` §5, cu 21 de locații pe 6 pagini:
> `zona-ilfov` (14), `zona-dambovita` (3), `zona-giurgiu`, `zona-arges`,
> `zona-calarasi` și `zona-constanta` (câte una).
>
> **`zona-brasov` nu a primit nicio locație** — vezi A93. Cardurile ei rămân
> exact cum erau, la fel și cele de pe `zona-constanta`: un nume nu umple un
...
valoarea nu e: `[NUME LOCAȚIE 1 — de confirmat]` e o sală din județul Brașov pe `zona-brasov`
...
| A93 | **Brașov nu apare în lista de locații** (rând nou, 18.09.2026) | `zona-brasov` | **deschis** | — | Pagina rămâne pe layout A cu cele trei carduri goale, sau se convertește la structura fără module de dovadă. Ambele variante cer o decizie, nu se pot amâna la nesfârșit: layout A e construit pe material care nu există. | |
| A94 | **Baza de calcul a transportului** — rând de referință, NU redeschis (18.09.2026) | cele 12 pagini de zonă, `zone`, `../oferte.html`, `../termeni-si-conditii.html` | **confirmat**, vezi A2 | `grand-music.ro` ×2: „6 RON/Km dus-întors” | — | **Dus-întors**, confirmat din sursă publică pe 2026-09-17 și scris deja pe toate paginile. Un marcaj `[BAZA DE CALCUL — de confirmat]` pus acum pe paginile de zonă ar contrazice `../oferte.html` și `../termeni-si-conditii.html`. Nu se adaugă. Verificat automat: `verify/integritate.py`, `check_transport()`. |
...
**De ce sunt cele mai riscante din tot setul.** Descriu cum lucrează echipa la un nivel de
detaliu pe care nu l-am primit de la nimeni: ce transport pleacă primul, când rămâne
echipa peste noapte, ce se face cu boxele într-o curte. Un cuplu le compară cu ce se
întâmplă la propria nuntă. O afirmație greșită aici nu e o imprecizie de stil, ci o
promisiune pe care echipa nu o respectă.

**Ce nu intră aici:** conținutul pachetelor care apare deja pe `oferte.html` (programele
de 2 × 45 de minute, DJ și MC, fumul greu, gheața carbonică, vulcanii CO2, capetele
mobile, cabina foto, momentul de virtuozitate, consultanța, diferența sâmbătă–duminică,
răspunsul în aceeași zi). Sunt deja publicate de client.
...
| B4 | Unde e cazare, echipa „rămâne peste noapte și demontează dimineață”, iar numărul de camere se stabilește după configurația pachetului. Camerele se caută „în aceeași locație sau în apropiere” (Brașov), „lângă locație, nu în Craiova” pentru localitățile de pe Dunăre (Dolj). | `zona-brasov`, `zona-dolj`, `zona-constanta` | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „trebuie verificat la telefon în funcție de distanță și tipul evenimentului”. Reformulat pe `zona-brasov`, `zona-dolj`, `zona-constanta`: rămânerea peste noapte și demontajul se stabilesc la discuția de organizare. |
...
| B9 | Oferta pleacă în aceeași zi **cu prețul final**, transportul și cazarea deja calculate: „pentru un preț ferm, nu pentru o estimare” (Giurgiu), pachet, drum și cazare pe rânduri separate (Dolj). | `zona-giurgiu`, `zona-dolj`, `zona-constanta`, `zona-brasov`, `zona-ilfov` | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17). Pe grand-music.ro rezervarea trece printr-o întâlnire („stabilim de comun acord o întâlnire pentru a discuta termenii și condițiile”); „în aceeași zi primiți … oferta” de pe ioana-balan.ro e textul prototipului. | ☑ da ☐ nu ☐ parțial | Pe `oferte.html` apare doar răspunsul în aceeași zi, nu și prețul ferm cu transport inclus. **2026-09-17.** Răspuns: „oferta pleacă cu prețurile finale, iar clienții trebuie să își aleagă un pachet”. „În aceeași zi” nu a fost comentat explicit. **2026-09-17, runda 2:** „în aceeași zi” scos de pe paginile noi (7 apariții), fără alt termen în loc; pe cele 6 pagini din contractul de bază (10 apariții) a fost restaurat, până la confirmarea din D13; a rămas doar ce e confirmat: prețuri finale, pachet ales de client. |
| B10 | Piesele cerute de familie care nu fac parte din repertoriul curent „se pregătesc înainte, nu se improvizează în seara nunții”. | `zona-prahova` | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17). Parțial: `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „Putem aborda anumite piese muzicale pe care doriți in mod excepțional.” Nu spune că se pregătesc înainte. | ☑ da ☐ nu ☐ parțial | **2026-09-17.** Răspuns: „da”. |
...
| # | Afirmație | Nivel | Sursa pe live | da / nu / parțial | Notă |
|---|---|---|---|---|---|
| B21 | Momentele importante se așază înaintea ultimei curse de bac, pentru invitații din Dobrogea. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☑ da ☐ nu ☐ parțial | **2026-09-17.** Răspuns: „da”. |
...
| B26 | Cu oră-limită de sonor, momentele cu volum mare intră devreme, iar finalul se acoperă „cu o formulă redusă sau acustică”. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☑ nu ☐ parțial | **Runda 2, clientul:** „asta nu trebuie să apară în site”. **Scos** (runda 2): întrebarea FAQ de pe `zona-constanta`, cu titlul secțiunii ajustat. |
...
| # | Afirmație | Nivel | Sursa pe live | da / nu / parțial | Notă |
|---|---|---|---|---|---|
| B37 | Sub cort, pe teren deschis, „boxele înalte și schela de lumini se ancorează”, iar scena stă pe latura ferită de vânt. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „se discută cu Liviu la telefon”. Reformulat pe `zona-ialomita`: ancorarea și poziția scenei intră pe lista discuției de organizare. |
...
| B42 | Într-o curte, „boxele se orientează dinspre case spre grădină”, iar volumul se calibrează pe curte. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „în funcție de sala în care se cântă”. Reformulat pe `zona-ilfov`: orientarea boxelor și volumul se lămuresc la discuția de organizare. |
| B43 | Cu salon vecin despărțit de un panou mobil, „cerem programul evenimentului vecin” și ajustăm nivelul. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☑ nu ☐ parțial | **Runda 2, clientul:** „asta nu trebuie să apară în site”. **Scos** (runda 2): întrebarea FAQ de pe `zona-ilfov`. |
...
| B46 | Când invitații pleacă spre București după miezul nopții, tortul, dansul mirilor și buchetul se mută mai devreme. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☑ da ☐ nu ☐ parțial | **2026-09-17.** Răspuns: „da”. |
...
| B48 | Vara, în curte: „Cerem un spațiu umbrit sau acoperit pentru scenă”, iar blocul de joc intens începe după apus. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „se discută cu Liviu la telefon”. Reformulat pe `zona-teleorman`: locul umbrit și mutarea jocurilor după apus sunt întrebări de la discuția de organizare. |
| B49 | La căminul cultural, volumul se reglează mai jos, iar boxele se așază altfel. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „în funcție de sala în care se cântă”. Reformulat pe `zona-teleorman`: volumul și așezarea boxelor la cămin se discută la organizare. |
...
| # | Afirmație | Nivel | Sursa pe live | da / nu / parțial | Notă |
|---|---|---|---|---|---|
| B57 | Manelele se cântă doar la cerere: „ce nu s-a cerut la discuția de organizare nu apare nici în seara evenimentului”. | **blocant** | Contradictoriu: `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „Nu abordăm genul muzical “manele”” · `grand-music.ro/oferta-formatii-nunta/` (mod. 2026-01-03): „1 interpret de muzică balcanica/manele(optional)*” · `ioana-balan.ro/faq/` (editat pe live): „acoperim și manele”. | ☑ da ☐ nu ☐ parțial | **2026-09-17.** Răspuns: „acoperim și manele”; opțional, contra cost, lăutar sau interpret de manele. Denumirea opțiunii rămâne deschisă: vezi D4. |
...
| B64 | La ruptul turtei, „muzica se oprește pe durata lui și repornește după”. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „se discută cu Liviu la telefon”. Reformulat pe `botez`: ce face muzica la ruptul turtei se hotărăște cu familia la discuția de organizare. |
| B65 | Boxele se orientează în direcția opusă locului unde stă copilul. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „în funcție de sala în care se cântă”. Reformulat pe `botez`: orientarea boxelor față de copil se stabilește la discuția de organizare. |

**`eveniment-privat`**

| # | Afirmație | Nivel | Sursa pe live | da / nu / parțial | Notă |
|---|---|---|---|---|---|
| B66 | La toast, „muzica se oprește de tot, nu doar coboară”. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☐ da ☐ nu ☑ parțial | **2026-09-17.** Răspuns: „se discută cu Liviu la telefon”. Reformulat pe `eveniment-privat`: oprire completă sau volum coborât, convenit cu gazda la organizare. |
...
| # | Afirmație | Nivel | Sursa pe live | da / nu / parțial | Notă |
|---|---|---|---|---|---|
| B68 | Coordonarea se face „cu o singură persoană de contact”; formația cere ordinea vorbitorilor și semnalul pentru intrarea de după discursuri. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☑ da ☐ nu ☐ parțial | Toată pagina depinde de D8. **2026-09-17.** Răspuns: „da”; D8: contract și factură pe firmă, direct. |
| B69 | La cină, volumul „coboară la fiecare fel servit”. | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17) | ☑ da ☐ nu ☐ parțial | **2026-09-17.** Răspuns: „da”. |
...
| B74 | Dansul mirilor cântat live: „Varianta live înseamnă un aranjament, deci piesa se trimite din timp”; în seară se cântă în aranjamentul convenit. | `nunta`, `repertoriu` | **blocant** | negăsit pe niciun domeniu (verificat 2026-09-17). `grand-music.ro/cele-mai-cautate-melodii-pentru-dansul-mirilor-2021/` (mod. 2021-01-24) spune doar că „Exista formatii pentru nunta care pot interpreta live melodia aleasa de miri pentru vals.” | ☑ da ☐ nu ☐ parțial | **2026-09-17.** Răspuns: „da”. |
| B75 | Lista de piese pe care gazdele nu vor să le audă se respectă în seara evenimentului („ce nu vreți să auziți”; „Piesele care nu se cântă deloc”). | `nunta`, `folclor-si-manele` | confirmat (runda 2) | `grand-music.ro/cat-costa-o-nunta-cum-facem-intrebari-fecvente/` (mod. 2025-06-13): „dacă există anumite melodii pe care nu le doriți în cadrul programului artistic, acestea se pot exclude.” Doar pe grand-music.ro. | ☑ da ☐ nu ☐ parțial | Legat de B57 **Runda 2:** confirmat, piesele nedorite se scot din program. Afirmația era deja fermă pe pagini și rămâne; niciun marcaj legat de ea. |
...
publicare, fără să afecteze un client. Trei rânduri care descriau și ce face formația
(contratimpul pe clapă sau acordeon, registrul oltenesc ca „coloana serii”, hora mare ca
moment comun) au fost mutate în B, ca B71–B73. Au fost scoase două afirmații pe care nu le
poate confirma nimeni: superlativul despre jocul rapid din Teleorman și afirmația despre
rudele familiilor din vestul Ialomiței.

Paginile nu spun nicăieri că artista a cântat într-o anumită zonă. Descriu **muzica
zonelor**. Tocmai de aceea, o afirmație greșită e verificabilă de oricine e din zona
respectivă. Titlurile de piese nu apar în text: au marcaje separate, în A6.
...
| C7 | Teleorman: satele de pe cele două maluri ale Oltului au fost „dintotdeauna în legătură, prin târguri, căsătorii și drumuri comune”. | `zona-teleorman` | ☐ da ☐ nu ☐ parțial | |
| C8 | Călărași: hora și sârba de Bărăgan se joacă „în cercuri mari”, iar fondul e comun cu al Ialomiței. | `zona-calarasi`, `zone` | ☐ da ☐ nu ☐ parțial | |
| C9 | Ialomița: Bărăganul a fost vreme de secole pășunea de iarnă a ciobanilor ardeleni, iar o parte dintre ei s-au așezat în satele de câmpie; „muzica de Săcele nu e aceeași cu cea din Mărginimea Sibiului”. | `zona-ialomita` | ☐ da ☐ nu ☐ parțial | |
| C10 | Buzău: cântece de deal „mai lungi la masă”; spre Râmnicu Sărat se cer și hore moldovenești, cu inflexiuni „de dincolo de Milcov”; pe valea spre Nehoiu, cântec de munte; „amestecul e mai firesc decât oriunde altundeva în Muntenia”. | `zona-buzau`, `zone` | ☐ da ☐ nu ☐ parțial | |
| C11 | Argeș: Muscelul are identitate proprie (brâul, jocurile de Muscel, cântecul de deal cu melodică largă), iar portul muscelean e printre cele mai cunoscute din țară. | `zona-arges`, `zone` | ☐ da ☐ nu ☐ parțial | |
| C12 | Argeș: spre Curtea de Argeș și Vâlcea, sârbele prind un tempo mai iute și o melodică apropiată de cea oltenească. | `zona-arges`, `repertoriu` | ☐ da ☐ nu ☐ parțial | |

### C2. Ardeal

| # | Afirmație | Pagini | da / nu / parțial | Notă |
|---|---|---|---|---|
| C13 | La nunțile din Țara Bârsei, prima parte a petrecerii merge pe învârtită, joc de doi și bărbunc, iar hora vine mai târziu, pentru invitații din alte zone. | `zona-brasov`, `repertoriu`, `zone` | ☐ da ☐ nu ☐ parțial | |
| C14 | Învârtita se joacă în pereche, pe o măsură care nu se împarte egal, „pe zece timpi în multe variante din Ardeal”, cu tempo ținut fix; pașii se învață în familie. | `repertoriu`, `zona-constanta` | ☐ da ☐ nu ☐ parțial | „Zece timpi” e cel mai specific detaliu tehnic din pagină |
| C15 | La jocul de doi, băiatul conduce, fata se rotește pe sub braț, iar fiecare pereche își alege momentul figurilor. | `repertoriu` | ☐ da ☐ nu ☐ parțial | |
| C16 | Bărbuncul vine din recrutările militare din secolul al XVIII-lea și a rămas jocul bărbaților, cu palme pe carâmbul cizmei și strigături. | `repertoriu` | ☐ da ☐ nu ☐ parțial | |
| C17 | Contra e o violă cu trei coarde și căluș drept, care trage acorduri pe timpii slabi; contrabasul marchează timpii tari; în nordul Ardealului vioara se numește ceteră. | `repertoriu`, `zona-brasov`, `zone` | ☐ da ☐ nu ☐ parțial | |
| C18 | În zona Branului și a Moieciului repertoriul „e deja amestecat, fiind la granița cu Muntenia”. | `zona-brasov` | ☐ da ☐ nu ☐ parțial | |
...
| # | Afirmație | Pagini | da / nu / parțial | Notă |
|---|---|---|---|---|
| C33 | Muzica lăutărească vine din tradiția tarafurilor de profesie: cântece de pahar, romanțe, hore și sârbe ornamentate liber. | `folclor-si-manele`, `formatia` | ☐ da ☐ nu ☐ parțial | |
| C34 | Manelele sunt un registru „construit pe refren și pe dedicație”, cu piese cerute pe nume. | `folclor-si-manele` | ☐ da ☐ nu ☐ parțial | |
...
| C44 | Moldova | **Întrebare deschisă, nu afirmație.** Ce se schimbă concret în melodie sau în pas la trecerea Milcovului, între Vrancea și Buzău? | `zona-vrancea` | Marcată pe pagină cu `.ph`: „[afirmație de folclor — de validat de Ioana]”. Pagina afirmă doar ce e deja în C40 — blocul moldovenesc e adaos la sud și material obișnuit la nord — și **întreabă** restul. `repertoriu.html` nu descrie nicio diferență de registru între cele două maluri ale Milcovului, deci pagina nu o inventează. Dacă răspunsul e „nu se schimbă nimic”, marcajul se scoate fără alt text. | ☐ da ☐ nu ☐ parțial |

---

## D. Decizii pe paginile existente și pe scope

**Contractul de bază** = cele 11 pagini existente (`index`, `oferte`, `despre`, `galerie`,
`discografie`, `contact`, `blog`, `articol`, `faq`, `termeni-si-conditii`,
`politica-cookie`). Punctele marcate **DA** cer modificări pe ele, deci **confirmare
scrisă înainte de execuție**. Până atunci nu se atinge nimic, nici măcar `description`
din JSON-LD.

| # | Decizie | Ce propunem | Modifică o pagină din contractul de bază? |
|---|---|---|---|
| D1 | **„formatie nunta” e targetat de 4 pagini:** `index` (title, H1, meta, JSON-LD), `galerie` (title), `blog` și `articol` (meta, JSON-LD). Toate au și „București”. Canibalizarea exista dinainte de paginile noi. | `index` păstrează termenul. `galerie`, `blog` și `articol` îl scot din title și meta (și din `description` în JSON-LD, unde apare). | **DA** — `galerie`, `blog`, `articol` |
| D2 | **FAQ duplicat:** 5 perechi întrebare–răspuns identice între `oferte` și `faq`, dintre care 2 („Prețul unei formații pentru 2026-2027?”, „Cum rezerv data — avans și contract?”) apar și pe `index`. | Răspunsul complet rămâne pe `faq` (singura pagină cu schema FAQPage). Pe `oferte` și `index` se scurtează, cu trimitere la `faq`. | **DA** — `oferte`, `index` |
| D3 | **„oferta formatie nunta” nu e targetat de nicio pagină**, nici de `oferte`: „ofertă” lipsește din title, H1 și headinguri. E cel mai ușor câștig din audit. | Termenul intră în title și H1 pe `oferte`. Condiție: D1 rezolvat înainte, ca `index` și `oferte` să nu țintească același „formatie nunta”. | **DA** — `oferte` |
| D4 | **Lăutarul:** `formatia.html` și `folclor-si-manele.html` îl oferă ca opțional, tarifat separat, dar în grila de pachete de pe `oferte.html` nu apare. Țambalul și interpretul balcanic, celelalte opționale, apar în grilă. | Clientul confirmă că oferă lăutar. Dacă da, se adaugă în grilă ca „(opțional)”, ca țambalul. Dacă nu, se scoate de pe cele două pagini noi (și B56, B59). **Răspuns (2026-09-17):** „poate apărea și este opțional plus onorariu”. În răspunsul la B57 clientul a propus pentru opțiune și denumirea „interpret de manele”, pentru că „sună mai premium”. **Neimplementat, de discutat cu clientul:** pe un site construit pe folclor autentic, „lăutar” e termenul cu prestigiu, legat de tradiția tarafurilor; „interpret de manele” numește un gen pe care paginile îl poziționează deliberat ca „la cerere”, pe `folclor-si-manele`, o pagină în afara navigației. Pus în grila de pachete, ar muta manelele din opțiune cerută în ofertă afișată. Cele două variante: (a) „lăutar (opțional)”, ca acum pe `formatia` („moment de lăutărie (opțional)”); (b) „interpret de manele (opțional)”. `formatia.html` rămâne pe (a) până la decizie. **Decizia clientului (runda 2): „interpret manele”.** Recomandarea noastră de brand era „lăutar”; s-a mers pe varianta clientului. Aplicat pe `formatia` (cardul opțional) și pe `folclor-si-manele` (secțiunea 5, lista de decizii și cardul de componență), în același regim: opțional, tarifat separat, fără nume, discutat la telefon. În grila de pe `oferte.html` apare deja „Un interpret de muzică balcanică (opțional)” la Premium; dacă e același rol, denumirile se aliniază la migrare. | **DA**, dacă răspunsul e „da” (`oferte`). Nu, dacă răspunsul e „nu” (se modifică doar pagini noi) |
| D5 | **Recenzia cu Silvia, pe `zona-constanta`:** citatul numește o „Silvia” cu „o voce foarte frumoasă”, alături de Ioana și Ionuț. Pe o pagină de județ, sugerează un eveniment acolo și o altă solistă. Nota de sub citat spune deja că recenzia nu e din Constanța. | **Amânat la final.** De confirmat cine e Silvia și dacă există o recenzie de la un eveniment din județ. | Nu — `zona-constanta` e pagină nouă (recenzia apare și pe `index`, dar acolo nu se schimbă nimic) |
| D6 | **Modelul de straturi e definit diferit.** `repertoriu`: (1) stratul regional, (2) stratul comun, cu muzică de petrecere **și** cântec ușor, (3) un al treilea strat, doar când mirii sunt din regiuni diferite, cu jocurile celeilalte familii. `folclor-si-manele`: (1) blocul regional, (2) stratul de petrecere, (3) **muzica ușoară**, deși „muzică ușoară de ring” e și unul dintre cele patru registre ale blocului de petrecere. | Se alege un singur model, iar cealaltă pagină se rescrie pe el. Ține și de B51. | Nu — ambele pagini sunt noi |
| D7 | **H2-urile de locații pe Brașov și Constanța** numesc tipuri de locații („Pensiuni la Bran și Moieciu, săli în oraș”; „Hoteluri pe litoral, terase pe faleză”). | De confirmat cu agenda reală, la completarea cardurilor de locație (A7). Dacă locațiile sunt altele, se schimbă heading-ul. | Nu |
| D8 | **Corporate:** se fac evenimente de firmă? Dacă da, cum se contractează? Pe `corporate.html` sunt 7 marcaje de text: 5 sunt condiții comerciale și contractuale neluate (facturare, contractare prin agenție, durată fixă, set scurt, termen pentru decembrie), 2 sunt de capacitate (prezentare în limbi străine, colinde). Al 8-lea marcaj e fotografia. | Răspunsul decide dacă pagina rămâne. **Dacă nu:** se scoate `corporate.html`, linkul din footer (NAV-FOOTER-MIGRARE §2), linkurile contextuale adăugate în runda asta (12 zone și hub) și cele existente de pe `repertoriu`, `formatia`, `nunta`, `botez` și `eveniment-privat`. **Răspuns (2026-09-17):** da, evenimente de firmă; contractul și factura se fac **pe firmă, direct** (nu prin agenție). Pagina rămâne. Marcajele A42 și A45 de pe `corporate` au fost completate în runda 2; pe pagină rămân 6 marcaje (fotografia și A43, A44, A46, A47, A48). | Nu — doar pagini noi. Volumul de modificări e însă mare dacă răspunsul e „nu” |
| D9 | **Specificația de 700 €:** ce conținea și dacă paginile de serviciu (`nunta`, `botez`, `eveniment-privat`, `corporate`) erau printre cele 7 slug-uri din Faza 3. **Documentul nu e în repo.** | De clarificat din contract sau din corespondență. Răspunsul decide dacă paginile de serviciu intră în prețul convenit sau sunt scope suplimentar, și ce slug-uri primesc. **Răspuns (2026-09-17):** „nu intrăm în subiect”. **Deschis** — reformulat în `DECIZII-CLIENT-URGENT.md` ca cerere de confirmare scrisă că paginile de serviciu fac parte din extinderea de 450 €, nu din contractul inițial. **Runda 2: confirmat verbal** — paginile pe tip de eveniment fac parte din extinderea de 450 €, nu din contractul inițial. E doar o confirmare verbală; **se cere și una scrisă**. | Nu modifică pagini, dar stabilește scope-ul |
| D10 | **Mutarea „Blog” din nav în footer.** Pentru ca „Zone” să intre în navigație fără să rupă header-ul (măsurat: CTA-ul ar ieși din fereastră cu 21,73 px la 1024), o intrare existentă trebuie să iasă. | Propunem „Blog”, pentru că paginile de zonă au intenție comercială directă, iar blogul are un singur articol. Linkul rămâne în footer (NAV-FOOTER-MIGRARE §1.1, §2). **Răspuns (2026-09-17):** da — „Blog” trece în footer, „Zone” intră în meniu. Neexecutat în runda asta (header-ul nu s-a atins). | **DA** — header-ul canonic, deci toate paginile |
| D11 | **Fotografie invizibilă în galerie.** Pe desktop, `rochie-alba-imprimeu` se randează într-o bandă de 2px din cauza `grid-template-rows` al grilei bento (măsurat la 1024 și 1440: `294.75px 2px …`), deci nu se vede. Defectul e anterior lucrării de acum și e înregistrat în `geometrie/galerie.md` (rândurile 161–162, înălțime 0). Reparația cere ajustarea span-urilor altor itemuri. | Variante: se scoate din grilă, sau se ajustează span-urile cu remăsurarea golurilor pe toate trei pragurile. **Neblocant**: galeria funcționează, doar una din 8 fotografii nu se vede pe desktop. | **DA** — `galerie` |
| D12 | **Țintă de tap sub minim în footer.** „Grand Music Events”, din rândul juridic al footer-ului, are 15px pe verticală, sub minimul de 44px din quality floor-ul proiectului. Defectul e anterior lucrării de acum și e pe **toate cele 31 de pagini**, pentru că e în footer-ul canonic. | Se repară o dată, la migrarea footer-ului în template unic (NAV-FOOTER-MIGRARE §2, „De rezolvat la migrare”, punctul 3). **Neblocant**: linkul funcționează, doar ținta de tap e sub minim. | **DA** — toate (footer-ul canonic) |
| D13 | **„Oferta pleacă în aceeași zi” — termen de răspuns neconfirmat.** Sintagma apare pe `index`, `oferte`, `faq`, `contact`, `despre` și `discografie`. Clientul a confirmat că oferta conține prețul final, dar nu termenul în care pleacă. E un angajament de timp pe care echipa nu îl controlează (apel în afara orelor, apel în timpul unui eveniment). | Pe cele 20 de pagini noi a fost scoasă; pe paginile existente se scoate la confirmare. **Neblocant**: textul rămâne până atunci, cum era. (Scoasă din greșeală și de pe cele 6 pagini în runda din 2026-09-17, apoi restaurată din git.) | **DA** — `index`, `oferte`, `faq`, `contact`, `despre`, `discografie` (6 pagini) |
| D14 | **Regulă de lansare — paginile fără locații rămân `noindex`** (19.09.2026, decizie proprie, nu întrebare) | `zona-mehedinti`, `zona-olt`, `zona-braila`, `zona-bacau` | Cele patru pagini sunt construite complet, dar nu au nicio locație confirmată în județ. La migrare **nu li se scoate `noindex`** până nu primesc cel puțin o locație. Motivul nu e calitatea textului, ci ce comunică un set: patru pagini de județ fără nicio dovadă locală, publicate deodată alături de cincisprezece care au, slăbesc întregul cluster în ochii unui vizitator care compară două-trei dintre ele. Se deblochează una câte una, pe măsură ce vin locațiile. Vezi S7 în `DECIZII-CLIENT-URGENT.md`. |
| D15 | **Vâlcea — suprapunere pe SERP-ul local cu domeniul clientului** (19.09.2026, de semnalat, nu de întrebat) | `zona-valcea` | `grand-music.ro/formatie-nunta-valcea/` există din 2025-06-13, cu title-ul „Formatii nunta Valcea \| suna acum pentru oferta 2025-2026”. E singurul dintre cele șapte județe noi unde clientul are deja pagină. `zona-valcea.html` evită deliberat „formație” în title și H1 — altfel ar fi încălcat și regula bag-of-words — și folosește „Cântec de Sub Carpați și Muzică de Petrecere”. Suprapunerea rămasă e pe toponim, și e inevitabilă. **La lansare, cele două pagini vor concura pe aceleași căutări locale.** Decizia despre care domeniu primește prioritate pe Vâlcea e a clientului, nu a noastră, și se ia înainte de indexare, nu după. |

D4, D8 și D10 au primit răspuns pe 2026-09-17; D4 (denumirea opțiunii) și D9 (confirmat verbal, se cere confirmare scrisă) s-au închis în runda 2.

**Sursa pentru D1–D3:** `AUDIT-KEYWORDS.md` (secțiunile A și B, plus „Decizii de luat cu
clientul”). `faq.html` e singura pagină cu `"@type": "FAQPage"`, verificat pe 2026-09-16.

---

## E. Observații pentru client — de semnalat, nu de întrebat

Nu blochează nimic și nu cer un răspuns pentru prototip. Sunt nepotriviri între ce e
publicat și ce știm acum; clientul trebuie doar să le afle.

| # | Observație | Detalii |
|---|---|---|
| E1 | **Termenul de plată a restului** apare în trei variante publicate. | `grand-music.ro` (FAQ): „în termen de 24h de la terminarea evenimentului” · `ioana-balan.ro/faq/`: „la finalul evenimentului” · `ioana-balan.ro/oferte/`: „în ziua evenimentului, înainte de începerea programului”. Sursa: `SURSE-LIVE.md`, C2. |
| E2 | **Cazarea:** `grand-music.ro` spune că o facturați voi, clientul spune că o asigură mirii. | `grand-music.ro` (FAQ): „percepem un cost suplimentar de transport […] și cazare”. Răspunsul din runda 2: se asigură de miri, detaliile la telefon cu Liviu. Paginile noi nu iau poziție: spun că modul concret se stabilește la discuția de organizare. Rămân însă pe paginile de zonă formulări mai vechi care pun cazarea în ofertă, alături de pachet și transport (de exemplu „pachet, transport și cazare, vizibile separat” pe `zona-dolj`, „cazarea deja calculate” pe `zona-constanta`, B9) — se revăd după ce clientul aliniază varianta publicată. |
| E3 | **Editările directe în WordPress** pe `ioana-balan.ro` nu există în versiunea de lucru și se pierd la republicare. | Cele patru valori: tariful de deplasare de 6 lei/km din Termeni (în prototip, `[TARIF]`), datele operatorului și ale găzduirii din Termeni (GRAND MUSIC EVENTS SRL, Săftica, Host-Age), avansul de 25% cu restul „la finalul evenimentului” din FAQ, raza de „circa 500 km” din FAQ (în prototip, 300 km). Tot pe `/faq/` mai sunt două editări de text: „acoperim și manele” și evenimentele „last minute”. Tariful editat pe `/oferte/` a fost între timp preluat în prototip. Sursa: `SURSE-LIVE.md`, §2. |

---

## Anexă: răspunsurile primei runde, verbatim

Copiate din `DECIZII-CLIENT-URGENT.md` așa cum au venit, completate pe 2026-09-17, înainte ca documentul să fie rescris pentru a doua rundă. Răspunsul e textul de după ultima bară, lipit de rând. Pe rândul de separator a rămas „aici nu inteleg intrebarea”, fără o întrebare atașată. **Închis în runda 2:** clientul nu își amintește la ce se referea și presupune că a răspuns. Secțiunea „De validat” (A2, A1/A3–A14, A17–A21, A24, B75) nu a primit răspuns scris; confirmările pentru prețuri, transport și cazare au venit separat.

```
| Temă | Ce trebuie confirmat | Ref. | Răspuns |
|---|---|---|---| aici nu inteleg intrebarea
| Prețuri | Oferta pleacă în aceeași zi, cu prețul final: pachet, transport și cazare | B9 | | oferta pleaca cu preturile finale iar clienti trebuie sa isi aleaga un pachet
| Cazare | Echipa rămâne peste noapte și demontează dimineața (sala trebuie să permită asta) | B4 | | trebuie verificat la telefon in functie de distanta si tipul evenimentului
| Tehnic | Ce putere electrică trebuie să asigure locația | A25, A27 | | de intrebat liviu 
| Tehnic | Cât durează montajul | A26 | | de intrebat liviu
| Sunet | Boxele se așază după spațiu: dinspre casele vecinilor într-o curte, departe de locul copilului la botez, cu volum mai mic la un cămin cultural | B42, B49, B65 | | in functie de sala in care se canta 
| Sunet | Când alături e alt eveniment, despărțit doar de un panou mobil, cerem programul lor și ajustăm volumul | B43 | | asta ramane de intrebat liviu
| Sunet | La o oră-limită de sonor, momentele cu volum mare intră devreme, iar finalul e în formulă redusă sau acustică | B26 | | de intrebat liviu
| Sunet | În aer liber, pe vânt, boxele înalte și schela de lumini se ancorează | B37 | | se discuta cu liviu la telefon 
| Sunet | Vara, în curte, cerem loc umbrit pentru scenă, iar jocurile intense încep după apus | B48 | | se discuta cu liviu la telefon 
| Programul serii | Muzica se oprește complet la toast și la ruptul turtei | B64, B66 | | se discuta cu liviu la telefon
| Programul serii | MC-ul verifică programul cu sala la începutul serii și coordonează momentele cu fotograful | B55, B60 | | da
| Programul serii | Dacă sala întârzie un fel de mâncare sau tortul, setul se lungește sau preia DJ-ul | B61 | | depinde de cerinte asta se discuta cu liviu la telefon
| Programul serii | Când invitații pleacă devreme (drum spre București, ultimul bac), tortul, dansul mirilor și momentele importante se mută mai devreme | B21, B46 | | da
| Piese | Dansul mirilor cântat live se trimite din timp, pentru aranjament; piesele cerute care nu sunt în repertoriu se pregătesc înainte | B10, B74 | | da
| Piese | Manelele se cântă doar la cerere. Pe site-uri apar acum trei variante: „nu abordăm manele”, interpret de manele opțional în pachetul Premium și „acoperim și manele”. Care e valabilă? | B57 | | acoperim si manele si optiional se poate adauga un lautar la pachet contracost sau interpret de manele cred ca suna mai premium 
| Evenimente de firmă | Formația primește ordinea vorbitorilor și semnalul de intrare; la cină, volumul scade la fiecare fel servit | B68, B69 | | da
| Servicii | Oferiți lăutar, ca opțional tarifat separat? Dacă da, apare și în grila de pachete | D4 | | poate aparea si este optional plus onorariu 
| Servicii | Faceți evenimente de firmă? Dacă da, contractul și factura se fac pe firmă, direct sau prin agenție? | D8 | | pe firma direct
| Contract | Ce conținea specificația de 700 € și dacă paginile de nuntă, botez, eveniment privat și corporate sunt incluse în ea | D9 | | nu intram in subiect 
| Meniu | Sunteți de acord ca „Blog” să treacă din meniu în subsolul site-ului, ca „Zone” să intre în meniu? | D10 | | da
| Ce am găsit publicat | Ref. |
|---|---|
| Transport în afara Bucureștiului și a Ilfovului: **6 lei/km, dus-întors** | A2 |
| Prețuri nuntă: Standard **5.500 €** sâmbăta și **4.800 €** duminica, Premium **6.500 €** sâmbăta și **5.500 €** duminica. Sunt valabile pentru București și Ilfov; în celelalte județe, prețul afișat „de la” se calculează din grilă plus transportul | A1, A3–A12, A14 |
| Cazarea echipei, când e nevoie de ea în afara Bucureștiului și a Ilfovului: **cost suplimentar, separat de pachet** | A17–A21 |
| Echipa tehnică ajunge la locație cu **4–5 ore înainte** de începerea evenimentului | A24 |
| Piesele pe care nu le vreți **se scot din program** | B75 |
```
